...
// Mot de passe oublié (étape 1). Sends a 6-digit recovery code to the email, then routes to
// /reset. Supabase returns success even for unknown emails, so we never reveal whether an
// account exists.
