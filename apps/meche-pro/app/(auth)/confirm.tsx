...
// 6-digit code; verifyOtp confirms the account and stores the session.

// Min delay between confirmation-email sends. Matches Supabase's fixed per-user 60s interval.
    ...
    <View style={{ flex: 1, backgroundColor: MPAL.bg, paddingTop: insets.top + 8 }}>
      ...
      >
        <MText variant="mono" size={10} color={MPAL.ink} style={{ letterSpacing: 1.4 }}>
          {lang === 'fr' ? 'ÉTAPE 2 · VÉRIFICATION' : 'STEP 2 · VERIFICATION'}
        </MText>
