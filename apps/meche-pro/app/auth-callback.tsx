...
import { MPAL, MText, PWordmark, useLang } from '@meche/ui';
import { supabase } from '../lib/supabase';

// Deep-link target for the email-confirmation link (mechepro://auth-callback?code=…). We exchange
// the PKCE code for a session here, then drop the user straight into the app.
